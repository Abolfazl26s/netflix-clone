...
// ++ ۱. useParams را از next/navigation وارد کنید ++
...
// ++ ۲. پراپرتی params دیگر از اینجا دریافت نمی‌شود ++
function MovieDetailsPage() {
  // ++ ۳. از هوک useParams برای گرفتن پارامترها استفاده کنید ++
  ...
  useEffect(() => {
    // اگر id وجود نداشت، کاری انجام نده
    if (!id) return;
    ...
    fetchDetails();
  }, [id]); // ++ ۴. id را به عنوان وابستگی useEffect اضافه کنید ++
  ...
  return (
    <div className="min-h-screen bg-[#141414]">
      ...
      <main className="pb-12">
        <div className="container-fluid mx-auto px-4 pt-24 lg:px-8">
          <nav className="text-sm text-gray-400 border p-4">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
            <div className="lg:col-span-2">
              ...
              <div className="mt-10">
                ...
                <div className="mt-4 grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2 xl:grid-cols-3">
